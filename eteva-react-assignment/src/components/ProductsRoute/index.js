  ...
  renderFailureView = () => (
    <div className="products-error-view-container">
      ...
      <p className="failure-description">
        We are having some trouble processing your request.Please retry.
      </p>
      <button className="retry-button" type="button">Retry</button>
    </div>
  )
